...
export default function Vaninsurance() {
  return (
    ...
    <div class='w-fill relative'>
      ...
      <div class='relative z-10 flex items-center justify-center text-center w-full sm:max-w-96 flex-col mpx-4 py-5 space-y-4 bg-opacity-80'>
        <h1 class='lg:text-white xl:text-white text-black text-xl sm:text-2xl xl:text-3xl font-bold'>VAN INSURANCE</h1>
